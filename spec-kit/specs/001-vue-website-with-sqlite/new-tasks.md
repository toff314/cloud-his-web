...
description: "Task list for Vue website with SQLite project"
---
...
- [ ] T043 [P] [US2] Contract test for GET /metadata endpoint in backend/tests/contract/test-metadata-api.js
- [ ] T044 [P] [US2] Contract test for GET /metadata/:page_slug endpoint in backend/tests/contract/test-metadata-slug-api.js

### Implementation for User Story 2

- [ ] T045 [P] [US2] Create ImageAsset model in backend/src/models/image-asset.model.js
- [ ] T046 [US2] Extend ContentService to handle metadata operations
- [ ] T047 [US2] Create ImageAsset service in backend/src/services/image-asset.service.js
- [ ] T048 [US2] Add metadata retrieval to metadata routes
- [ ] T049 [US2] Create metadata management components in frontend/src/components/MetadataEditor.vue
- [ ] T050 [US2] Add metadata display to ContentDisplay component
- [ ] T051 [US2] Implement metadata update functionality
- [ ] T052 [US2] Add SEO meta tags to page head based on metadata
...
- [ ] T053 [P] [US3] Contract test for GET /images endpoint in backend/tests/contract/test-images-api.js

### Implementation for User Story 3

- [ ] T054 [P] [US3] Create ImageAssets routes in backend/src/routes/image-assets.route.js
- [ ] T055 [US3] Add image asset retrieval to ImageAsset service
- [ ] T056 [US3] Create ImageGallery component in frontend/src/components/ImageGallery.vue
- [ ] T057 [US3] Implement local image display in ContentDisplay component
- [ ] T058 [US3] Add image asset listing functionality
- [ ] T059 [US3] Ensure no external image upload functionality exists
...
- [US2] Depends on User Story 1 completion
- [US3] Depends on User Story 1 completion
